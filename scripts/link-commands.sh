...
# any runtime's commands dir and every command in memory/commands/
# gets linked in.
#
# Canonical store (source of truth): ~/.claude-memory/commands/
...
COMMANDS_SRC="${COMMANDS_SRC:-$(cd "$(dirname "$0")/.." && pwd)/commands}"
DRY_RUN=0
TARGET=""
