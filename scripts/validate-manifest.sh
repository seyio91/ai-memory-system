...
KNOWN_KEYS=" name archetype format hooks_dir statusline commands commands_dir skills_dir agents_dir context_target refresh exec exec_cmd exec_model_flag exec_readonly "
