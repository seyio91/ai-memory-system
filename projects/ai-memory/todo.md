...
- [ ] Phase 2 — guard: Copilot stdin path + JSON deny output branch + timeoutSec + real-stdin fixture (fails closed, not warned)
- [ ] Phase 3 — compaction + breadcrumb: preCompact sentinel arm + postToolUse re-inject/clear
