...
### /new-plan converges plan-first work back onto /start → [plan](plans/new-plan-converges-onto-start.md)
...
- [ ] Checkpoint — full suite + lint baseline 18 + live exercise + human review (needs: P3, P4)
